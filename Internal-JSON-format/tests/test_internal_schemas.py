...
from schema_testing import (
    BaseDatatypeTest, describe_validation_error,
    RequireExplicitAdditionalProperties, RequireExplicitOptionalProperties)


class TestInternalItem(BaseDatatypeTest, RequireExplicitAdditionalProperties,
                       RequireExplicitOptionalProperties):
    schema_base_uri = 'https://schemas.cudl.lib.cam.ac.uk/__internal__/v1/'
    data_type = 'item'
    expected_valid_count = 4
    expected_invalid_count = 12
